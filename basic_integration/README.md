...
| Lightlytics_internal_accountID    | Lightlytics internal id                 |                                                                              | `string` | Yes       | n/a     |
| lightlytics_account_externalID    | Lightlytics external id                 |                                                                              | `string` | Yes       | n/a     |
| lightlytics_auth_token            | Lightlytics auth token                  |                                                                              | `string` | Yes       | n/a     | 
